...
import 'package:lumen/screens/authenticate/register/professional/registerProfessional.dart';
import 'package:lumen/shared/loading.dart';

// ignore: must_be_immutable
class CommitmentTermProfessional extends StatefulWidget {
  ...
  final List<String> checked, checked1, usaOutros, comoEncontrou;
  String salutatione = "Acre (AC)", quaisEqp = '';
  final DateTime dateTime;
  CommitmentTermProfessional(
      {Key key,
        this.toggleView,
        this.email,
        this.password,
  ...
  @override
  _CommitmentTermProfessionalState createState() => _CommitmentTermProfessionalState();
}

class _CommitmentTermProfessionalState extends State<CommitmentTermProfessional> {
              ...
              Container(
                ...
                child: RaisedButton(
                  //button
                    ...
                    onPressed: isEnabled
                        ? ()  {
                      Navigator.push(context, SlideRightRoute(widget: RegisterProfessional()));
                    }
                        : null
                ),
              ),
