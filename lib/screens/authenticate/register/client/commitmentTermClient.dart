...
class CommitmentTerm extends StatefulWidget {
  ...
  final List<String> checked, checked1, comoEncontrou;
  ...
  @override
  _CommitmentTermState createState() => _CommitmentTermState();
}

class _CommitmentTermState extends State<CommitmentTerm> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                    ...
                    onPressed: isEnabled
                        ? ()  {
                              Navigator.push(context, SlideRightRoute(widget: Register()));
                          }
                        : null
                    ),
              ),
